...
(function($PS) {
  ...
  var loadList = function (dictReadForeign) {
      return function (uri) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(uri))(function (response) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                  ...
                  if (response instanceof Data_Either.Right) {
                      return parseList(dictReadForeign)(response.value0.body);
                  };
                  throw new Error("Failed pattern match at BookClient.Shared (line 87, column 10 - line 89, column 53): " + [ response.constructor.name ]);
              })());
          });
      };
  };
  var loadItem = function (dictReadForeign) {
      return function (uri) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(uri))(function (response) {
              ...
              if (response instanceof Data_Either.Right) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Bifunctor.bimap(Data_Either.bifunctorEither)(Data_Show.show(Data_List_Types.showNonEmptyList(Foreign.showForeignError)))(Control_Category.identity(Control_Category.categoryFn))(Simple_JSON.readJSON(dictReadForeign)(response.value0.body)));
              };
              throw new Error("Failed pattern match at BookClient.Shared (line 80, column 3 - line 82, column 72): " + [ response.constructor.name ]);
          });
      };
  };
...
(function($PS) {
  ...
  var Assets = (function () {
      function Assets(value0) {
          this.value0 = value0;
      };
      Assets.create = function (value0) {
          return new Assets(value0);
      };
      return Assets;
  })();
  var ClientRoute = (function () {
      function ClientRoute(value0) {
          this.value0 = value0;
      };
      ClientRoute.create = function (value0) {
          return new ClientRoute(value0);
      };
      return ClientRoute;
  })();
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof ClientRoute) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(x.value0)));
      };
      throw new Error("Failed pattern match at Books (line 25, column 1 - line 25, column 51): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return BooksIndex.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return new Book(x.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return new Assets(x.value0.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inr)) {
          return new ClientRoute(x.value0.value0.value0);
      };
      throw new Error("Failed pattern match at Books (line 25, column 1 - line 25, column 51): " + [ x.constructor.name ]);
  });
  var apiRouteCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      return "BooksIndex";
  }))()(Routing_Duplex_Generic.gRouteNoArguments))(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      return "Book";
      ...
      Book: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteArgument))("api")(Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteAll))("books")(Routing_Duplex.segment)),
      BooksIndex: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("api")(Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("books")(Routing_Duplex_Generic.noArgs)),
      Assets: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteAll))("assets")(Routing_Duplex.rest),
      ClientRoute: Routing_Duplex.rest
  }));
  exports["apiRouteCodec"] = apiRouteCodec;
  exports["BooksIndex"] = BooksIndex;
  exports["Book"] = Book;
})(PS);
(function($PS) {
...
(function($PS) {
  ...
  var saveBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.request({
              ...
              url: Routing_Duplex.print(Books.apiRouteCodec)(Books.BooksIndex.value),
              ...
              if (response instanceof Data_Either.Right && response.value0.status === 204) {
              ...
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  $28.posting = false;
                  $28.message = BookClient_Shared.warningMessage(Data_Either.either(function (v2) {
  ...
  var component = (function () {
      ...
      var handleAction = function (action) {
          ...
          throw new Error("Failed pattern match at BookClient.Books.Create (line 91, column 6 - line 100, column 49): " + [ action.constructor.name ]);
      };
...
(function($PS) {
  ...
  var loadBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(BookClient_Shared.loadItem(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "title";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()()))("/api/books/" + v.book.isbn)))(function (maybeBook) {
          if (maybeBook instanceof Data_Either.Left) {
              return Halogen_Query_HalogenM.raise(new BookClient_Navigation.NavigateToRoute(BookClient_Navigation.BooksIndex.value));
          };
          if (maybeBook instanceof Data_Either.Right) {
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  var $13 = {};
                  for (var $14 in v) {
                  ...
                  $13.book = maybeBook.value0;
                  return $13;
              })());
          };
          throw new Error("Failed pattern match at BookClient.Books.Delete (line 98, column 3 - line 102, column 39): " + [ maybeBook.constructor.name ]);
      });
  });
  var deleteBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.request({
              ...
              url: Routing_Duplex.print(Books.apiRouteCodec)(new Books.Book(v.book.isbn)),
              headers: [ Affjax_RequestHeader.ContentType.create("application/json") ],
              ...
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  $26.posting = false;
                  $26.message = BookClient_Shared.warningMessage(Data_Either.either(function (v2) {
                      return "Unknown Error";
                  })(function (v2) {
                      return v2.body;
                  })(response));
  ...
  var component = (function () {
      ...
      var handleAction = function (action) {
          ...
          throw new Error("Failed pattern match at BookClient.Books.Delete (line 84, column 6 - line 91, column 49): " + [ action.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.request({
              ...
              if (response instanceof Data_Either.Right && response.value0.status === 204) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $28.posting = false;
                      $28.message = BookClient_Shared.successMessage("Book updated successfully");
                      return $28;
                  })());
              };
              if (response instanceof Data_Either.Right && response.value0.status === 201) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $33 = {};
                      for (var $34 in v) {
                      ...
                      $33.posting = false;
                      $33.message = BookClient_Shared.successMessage("Book created successfully");
                      return $33;
                  })());
              };
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  $38.posting = false;
                  $38.message = BookClient_Shared.warningMessage(Data_Either.either(function (v2) {
                      return "Unknown Error";
                  })(function (v2) {
                      return v2.body;
                  })(response));
  ...
  var maybeSaveBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      var validation = BookClient_Books_Shared.validateBook(v.book);
      var $43 = Data_Map_Internal.isEmpty(validation);
      if ($43) {
          return saveBook;
      };
      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          $44.message = BookClient_Shared.warningMessage("There are some changes needed to save this book");
          return $44;
      })());
  });
  var loadBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(BookClient_Shared.loadItem(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          if (maybeBook instanceof Data_Either.Right) {
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  $51.book = maybeBook.value0;
                  return $51;
              })());
          };
          throw new Error("Failed pattern match at BookClient.Books.Edit (line 107, column 3 - line 111, column 39): " + [ maybeBook.constructor.name ]);
      });
  });
  var component = (function () {
      var render = function (v) {
      ...
      var handleAction = function (action) {
          ...
          throw new Error("Failed pattern match at BookClient.Books.Edit (line 91, column 6 - line 100, column 49): " + [ action.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
  ...
  var loadBooksIntoState = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(BookClient_Shared.loadList(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
      ...
      return "title";
  }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()()))(Routing_Duplex.print(Books.apiRouteCodec)(Books.BooksIndex.value))))(function (books) {
  ...
  var component = (function () {
      ...
      var handleAction = function (action) {
          ...
          throw new Error("Failed pattern match at BookClient.Books.List (line 64, column 6 - line 76, column 59): " + [ action.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.navbar, Halogen_Themes_Bootstrap4.navbarDark, Halogen_Themes_Bootstrap4.fixedTop, Halogen_Themes_Bootstrap4.bgDark, Halogen_Themes_Bootstrap4.p0, Halogen_Themes_Bootstrap4.shadow ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.navbarBrand, Halogen_Themes_Bootstrap4.colSm3, Halogen_Themes_Bootstrap4.colMd2, Halogen_Themes_Bootstrap4.mr0 ]), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("id3as") ]), Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.navbarNav, Halogen_Themes_Bootstrap4.px3 ]) ])([ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.navItem, Halogen_Themes_Bootstrap4.textNowrap ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.navLink ]), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text("Sign out") ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.containerFluid) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd2, Halogen_Themes_Bootstrap4.dNone, Halogen_Themes_Bootstrap4.dBlock, Halogen_Themes_Bootstrap4.bgLight, "sidebar" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "sidebar-sticky" ]) ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.nav, Halogen_Themes_Bootstrap4.flexColumn ]) ])([ Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.navItem) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.classes(navLinkClass(v.activeRoute)(BookClient_Navigation.BooksIndex.value)), Halogen_HTML_Properties.href(Routing_Duplex.print(BookClient_Navigation.routeCodec)(BookClient_Navigation.BooksIndex.value)) ])([ Halogen_HTML_Core.text("Books") ]) ]) ]) ]) ]), Halogen_HTML_Elements.main([ Halogen_HTML_Properties.attr("role")("main"), Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd9, "ml-sm-auto", Halogen_Themes_Bootstrap4.colLg10, Halogen_Themes_Bootstrap4.px4 ]) ])([ Halogen_HTML_Elements.nav([ Halogen_HTML_Properties_ARIA.label("breadcrumb") ])([ Halogen_HTML_Elements.ol([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.breadcrumb) ])(Data_Array.cons(Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.breadcrumbItem) ])([ Halogen_HTML_Core.text("Home") ]))(gatherBreadcrumbs(v.activeRoute))) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.mt2 ]) ])([ (function () {
              ...
              throw new Error("Failed pattern match at BookClient.Main (line 101, column 15 - line 106, column 108): " + [ v.activeRoute.constructor.name ]);
          })() ]) ]) ]) ]) ]);
      };
      var initialState = {
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at BookClient.Main (line 114, column 18 - line 123, column 37): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(BookClient_Main.component)(Data_Unit.unit)(body))(function (driver) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_PushState.makeInterface))(function (nav) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(BookClient_Main.routeSignal(nav)(driver)))(function () {
                  return driver.subscribe(Control_Coroutine.consumer(Effect_Aff.monadAff)(function (msg) {
                      return Data_Functor.voidLeft(Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(nav.pushState(Simple_JSON.write(Simple_JSON.recordWriteForeign()(Simple_JSON.nilWriteForeignFields))({}))(Routing_Duplex.print(BookClient_Navigation.routeCodec)(msg.value0))))(Data_Maybe.Nothing.value);
                  }));
              });
          });
      });
