      ...
      return function (uri) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(uri))(function (v) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                  ...
                  if (v instanceof Data_Either.Right) {
                      return parseList(dictReadForeign)(v.value0.body);
                  };
                  throw new Error("Failed pattern match at BookClient.Shared (line 87, column 10 - line 89, column 53): " + [ v.constructor.name ]);
              })());
          });
      };
  };
  var loadItem = function (dictReadForeign) {
      return function (uri) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(uri))(function (v) {
              ...
              if (v instanceof Data_Either.Right) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Bifunctor.bimap(Data_Either.bifunctorEither)(Data_Show.show(Data_List_Types.showNonEmptyList(Foreign.showForeignError)))(Control_Category.identity(Control_Category.categoryFn))(Simple_JSON.readJSON(dictReadForeign)(v.value0.body)));
              };
              throw new Error("Failed pattern match at BookClient.Shared (line 80, column 3 - line 82, column 72): " + [ v.constructor.name ]);
          });
      };
  };
...
(function($PS) {
  ...
  var saveBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.request({
              ...
              if (v2 instanceof Data_Either.Right && v2.value0.status === 204) {
              ...
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  $31.posting = false;
                  $31.message = BookClient_Shared.warningMessage(Data_Either.either(function (v4) {
  ...
  var maybeSaveBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      ...
      var $36 = Data_Map_Internal.isEmpty(validation);
      if ($36) {
          return saveBook;
      };
      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          $37.message = BookClient_Shared.warningMessage("There are some changes needed to save this new book");
          return $37;
      })());
  });
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div([  ])([ BookClient_Shared.renderMessage(v.message), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formGroup) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("isbn") ])([ Halogen_HTML_Core.text("Isbn") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formControl), Halogen_HTML_Properties.id_("isbn"), Halogen_HTML_Properties.value(v.book.isbn), Halogen_HTML_Events.onValueInput(function ($53) {
              return Data_Maybe.Just.create(IsbnChanged.create($53));
          }) ]), BookClient_Shared.validationFor(v.validation)("isbn")("This is the registered ISBN of the book") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formGroup) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("title") ])([ Halogen_HTML_Core.text("Title") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formControl), Halogen_HTML_Properties.id_("title"), Halogen_HTML_Properties.value(v.book.title), Halogen_HTML_Events.onValueInput(function ($54) {
              return Data_Maybe.Just.create(TitleChanged.create($54));
          }) ]), BookClient_Shared.validationFor(v.validation)("title")("I think this is self-explanatory no?") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formGroup) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("author") ])([ Halogen_HTML_Core.text("Author") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formControl), Halogen_HTML_Properties.id_("author"), Halogen_HTML_Properties.value(v.book.author), Halogen_HTML_Events.onValueInput(function ($55) {
              return Data_Maybe.Just.create(AuthorChanged.create($55));
...
(function($PS) {
  ...
  var saveBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.request({
              ...
              if (v2 instanceof Data_Either.Right && v2.value0.status === 201) {
                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $37 = {};
                      for (var $38 in v) {
                          if ({}.hasOwnProperty.call(v, $38)) {
                      ...
                      $37.posting = false;
                      $37.message = BookClient_Shared.successMessage("Book created successfully");
                      return $37;
                  })());
              };
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                  ...
                  $42.posting = false;
                  $42.message = BookClient_Shared.warningMessage(Data_Either.either(function (v4) {
                      return "Unknown Error";
                  })(function (v4) {
                      return v4.body;
                  })(v2));
  ...
  var maybeSaveBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      var validation = BookClient_Books_Shared.validateBook(v.book);
      var $47 = Data_Map_Internal.isEmpty(validation);
      if ($47) {
          return saveBook;
      };
      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          $48.message = BookClient_Shared.warningMessage("There are some changes needed to save this book");
          return $48;
      })());
  });
  var loadBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div([  ])([ BookClient_Shared.renderMessage(v.message), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formGroup) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("isbn") ])([ Halogen_HTML_Core.text("Isbn") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formControl), Halogen_HTML_Properties.id_("isbn"), Halogen_HTML_Properties.value(v.book.isbn), Halogen_HTML_Properties.readOnly(true) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formGroup) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("title") ])([ Halogen_HTML_Core.text("Title") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formControl), Halogen_HTML_Properties.id_("title"), Halogen_HTML_Properties.value(v.book.title), Halogen_HTML_Events.onValueInput(function ($73) {
              return Data_Maybe.Just.create(TitleChanged.create($73));
          }) ]), BookClient_Shared.validationFor(v.validation)("title")("I think this is self-explanatory no?") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formGroup) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("author") ])([ Halogen_HTML_Core.text("Author") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formControl), Halogen_HTML_Properties.id_("author"), Halogen_HTML_Properties.value(v.book.author), Halogen_HTML_Events.onValueInput(function ($74) {
              return Data_Maybe.Just.create(AuthorChanged.create($74));
          }) ]), BookClient_Shared.validationFor(v.validation)("author")("As is this") ]), (function () {
              var $63 = !v.posting;
              if ($63) {
                  return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnPrimary ]), Halogen_HTML_Events.onClick(function (e) {
