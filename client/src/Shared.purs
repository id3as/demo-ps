...
import Affjax.ResponseFormat as XResponse
...
validationFor validation name default = case Map.lookup name validation of
  Nothing -> HH.small [ HP.classes [ B.formText, B.textMuted ], HP.id $ name <> "-help" ] [ HH.text default ]
  Just message -> HH.small [ HP.classes [ B.formText, B.textDanger ], HP.id $ name <> "-help" ] [ HH.text message ]
