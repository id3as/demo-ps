...
(function($PS) {
  ...
  var eqIsbnId = Data_Eq.eqString;
  exports["eqIsbnId"] = eqIsbnId;
  exports["readIsbnId"] = readIsbnId;
  exports["writeIsbnId"] = writeIsbnId;
  exports["ntIsbnId"] = ntIsbnId;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var validateBook = function (book) {
      return Data_Map_Internal.unions(Data_Ord.ordString)(Data_Foldable.foldableArray)([ (function () {
          ...
          var $3 = Data_Eq.eq(Books.eqIsbnId)(book.isbn)(Data_Newtype.wrap(Books.ntIsbnId)(""));
          if ($3) {
...
(function($PS) {
      ...
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.request({
              ...
              content: Data_Maybe.Just.create(Affjax_RequestBody.string(Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "isbn";
              }))(Books.writeIsbnId)(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                  return "title";
  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div([  ])([ BookClient_Shared.renderMessage(v.message), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formGroup) ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties["for"]("isbn") ])([ Halogen_HTML_Core.text("Isbn") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.formControl), Halogen_HTML_Properties.id_("isbn"), Halogen_HTML_Properties.value(Data_Newtype.unwrap(Books.ntIsbnId)(v.book.isbn)), Halogen_HTML_Events.onValueInput(function ($50) {
      ...
      var initialState = function (v) {
          return {
              ...
              posting: false,
              book: {
                  isbn: Data_Newtype.wrap(Books.ntIsbnId)(""),
                  title: "",
                  author: ""
              },
      ...
      var handleAction = function (action) {
          if (action instanceof IsbnChanged) {
              return updateBook(function (b) {
                  return {
                      isbn: Data_Newtype.wrap(Books.ntIsbnId)(action.value0),
                      title: b.title,
                      author: b.author
                  };
              });
          ...
          throw new Error("Failed pattern match at BookClient.Books.Create (line 90, column 6 - line 99, column 49): " + [ action.constructor.name ]);
      };
...
(function($PS) {
  ...
  var loadBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(BookClient_Shared.loadItem(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          return "isbn";
      }))(Books.readIsbnId)(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "title";
      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()()))("/api/books/" + Data_Newtype.unwrap(Books.ntIsbnId)(v.book.isbn))))(function (maybeBook) {
          ...
          throw new Error("Failed pattern match at BookClient.Books.Delete (line 96, column 3 - line 100, column 39): " + [ maybeBook.constructor.name ]);
      });
  });
  var deleteBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.request({
              ...
              url: "/api/books/" + Data_Newtype.unwrap(Books.ntIsbnId)(v.book.isbn),
              headers: [ Affjax_RequestHeader.ContentType.create("application/json") ],
  ...
  var component = (function () {
      ...
      var initialState = function (isbn) {
          return {
              ...
              posting: false,
              book: {
                  isbn: Data_Newtype.wrap(Books.ntIsbnId)(Data_Newtype.unwrap(BookClient_Books_Shared.ntBookInput)(isbn)),
                  title: "",
                  author: ""
              }
          };
...
(function($PS) {
  ...
  var loadBook = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(BookClient_Shared.loadItem(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
          ...
          throw new Error("Failed pattern match at BookClient.Books.Edit (line 105, column 3 - line 109, column 39): " + [ maybeBook.constructor.name ]);
      });
  });
  var component = (function () {
      var render = function (v) {
...
(function($PS) {
  ...
  var loadBooksIntoState = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(BookClient_Shared.loadList(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
      ...
      return "title";
  }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()()))("/api/books")))(function (books) {
      ...
      var handleAction = function (action) {
          ...
          if (action instanceof EditBook) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(action.value1)))(function () {
                  return Halogen_Query_HalogenM.raise(BookClient_Navigation.NavigateToRoute.create(BookClient_Navigation.BooksEdit.create(Data_Newtype.unwrap(Books.ntIsbnId)(action.value0.isbn))));
              });
          };
          ...
          if (action instanceof DeleteBook) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.preventDefault(action.value1)))(function () {
                  return Halogen_Query_HalogenM.raise(BookClient_Navigation.NavigateToRoute.create(BookClient_Navigation.BooksDelete.create(Data_Newtype.unwrap(Books.ntIsbnId)(action.value0.isbn))));
              });
          };
          throw new Error("Failed pattern match at BookClient.Books.List (line 63, column 6 - line 75, column 68): " + [ action.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
